...
public PlayerTurnState(BattleSystem battleSystem) : base(battleSystem)
    ...
    public override void Start()
    {
        ...
        TechBase techBase = BattleSystem.PTech;

        AttackTurn(techBase, pZori, eZori);
    }
    ...
    private void AttackTurn(TechBase tech, Zori sender, Zori receiver)
    {
        ...
        BattleSystem.PlayerHUD.UpdateDialBox(sender.Nickname.ToString() + " use " + tech.Name.ToString());
